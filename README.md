...
A cloud storage and file sharing platform inspired by Google Drive, built with enterprise-grade architecture using Java Spring Boot and React.



## Overview

This application provides a secure, feature-rich file storage solution enabling users to upload, organize, search, and share files with fine-grained permission controls. Designed as an industry-ready MVP.
